...
export function ProjectRequestDetails({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl w-[96vw] h-[96vh] overflow-hidden flex flex-col bg-gradient-to-br from-slate-50 to-white border-0 shadow-2xl">
        {/* Modern Header with Gradient Background */}
        <DialogHeader className="flex-shrink-0 px-8 py-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            <div className="flex items-start justify-between gap-6">
              <div className="flex items-center gap-4 min-w-0 flex-1">
                <Avatar className="w-16 h-16 flex-shrink-0 ring-4 ring-white/30 shadow-lg">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <DialogDescription className="flex items-center gap-2 text-blue-100">
                    <MapPin className="w-5 h-5 flex-shrink-0" />
                    <span className="truncate text-base">{request.location}</span>
                  </DialogDescription>
                  <div className="flex items-center gap-3 mt-2">
                    <div className="flex items-center gap-1 text-white/90">
                      <Target className="w-4 h-4" />
                      <span className="text-sm font-medium">{request.estimatedCapacity} kW</span>
                    </div>
                    {request.estimatedBudget && (
                      <div className="flex items-center gap-1 text-white/90">
                        <DollarSign className="w-4 h-4" />
                        <span className="text-sm font-medium">{formatCurrency(request.estimatedBudget)}</span>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-center">
                ...
                <div className="text-white font-mono font-semibold truncate">#{request.id}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-center">
                <div className="text-white/80 text-xs uppercase tracking-wide">Kaynak</div>
                <div className="text-white font-semibold truncate">{getSourceLabel(request.source)}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-center">
                <div className="text-white/80 text-xs uppercase tracking-wide">Proje Türü</div>
                <div className="text-white font-semibold truncate">{PROJECT_TYPE_LABELS[request.projectType]}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-center">
                <div className="text-white/80 text-xs uppercase tracking-wide">Notlar</div>
                <div className="text-white font-semibold">{request.notes.length}</div>
              </div>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Müşteri Bilgileri</h3>
                    <p className="text-slate-500 text-sm">İletişim ve adres detayları</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="group">
                      <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="font-semibold text-slate-900">{request.customerPhone}</div>
                        </div>
                        <Button 
                          size="sm" 
                          variant="ghost" 
                    ...
                    <div className="group">
                      <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                        ...
                        <div className="flex-1">
                          <div className="text-xs text-slate-500 uppercase tracking-wide mb-1">E-posta</div>
                          <div className="font-semibold text-slate-900 truncate">{request.customerEmail}</div>
                        </div>
                        <Button 
                          size="sm" 
                          variant="ghost" 
                  ...
                  <div className="p-3 bg-slate-50 rounded-xl">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-xs text-slate-500 uppercase tracking-wide mb-1">Adres</div>
                        <div className="font-semibold text-slate-900 leading-relaxed">{request.address}</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Proje Detayları</h3>
                    <p className="text-slate-500 text-sm">Teknik özellikler ve gereksinimler</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-blue-800">Kapasite</span>
                    </div>
                    <div className="text-2xl font-bold text-blue-900">{request.estimatedCapacity} kW</div>
                    <div className="text-xs text-blue-600 mt-1">Tahmini güç kapasitesi</div>
                  </div>
                  ...
                  {request.estimatedBudget && (
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-100">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium text-green-800">Bütçe</span>
                      </div>
                      <div className="text-2xl font-bold text-green-900">{formatCurrency(request.estimatedBudget)}</div>
                      <div className="text-xs text-green-600 mt-1">Müşteri bütçesi</div>
                    </div>
                  )}
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-purple-800">Proje Türü</span>
                    </div>
                    <div className="text-lg font-bold text-purple-900">{PROJECT_TYPE_LABELS[request.projectType]}</div>
                    <div className="text-xs text-purple-600 mt-1">Kurulum tipi</div>
                  </div>
                  
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-100">
                    <div className="flex items-center gap-2 mb-2">
                      <Activity className="w-5 h-5 text-orange-600" />
                      <span className="text-sm font-medium text-orange-800">Kaynak</span>
                    </div>
                    <div className="text-lg font-bold text-orange-900">{getSourceLabel(request.source)}</div>
                    <div className="text-xs text-orange-600 mt-1">Talep kaynağı</div>
                  </div>
                </div>
          ...
          <div className="w-full lg:w-96 border-t lg:border-t-0 lg:border-l border-slate-200 px-4 lg:pl-8 py-6 overflow-y-auto bg-slate-50/50">
            <div className="space-y-6">
              {/* Status History */}
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">Durum Geçmişi</h3>
                    ...
                    <div key={item.id} className="relative">
                      ...
                      <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {item.note && (
                            <div className="text-xs mt-2 text-slate-600 bg-white rounded-lg p-2 border">
                              {item.note}
                            </div>
                          )}
                        </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    <span className="text-slate-500 text-sm">Talep No</span>
                    <div className="flex items-center gap-2">
                      <span className="font-mono font-semibold text-slate-900">#{request.id}</span>
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    <span className="text-slate-500 text-sm">Oluşturma</span>
                    <span className="text-sm font-medium text-slate-900">{formatDate(request.createdAt)}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-slate-100">
                    <span className="text-slate-500 text-sm">Güncelleme</span>
                    <span className="text-sm font-medium text-slate-900">{formatDate(request.updatedAt)}</span>
                  </div>
                  {request.estimatedRevenue && (
                    <div className="flex justify-between items-center py-2">
                      <span className="text-slate-500 text-sm">Tahmini Gelir</span>
                      <span className="text-sm font-bold text-emerald-600">{formatCurrency(request.estimatedRevenue)}</span>
                    </div>
                  )}
                </div>
              </div>
