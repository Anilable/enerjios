...
import { Document, Page, Text, View, StyleSheet, Svg, Circle, Line, Rect } from '@react-pdf/renderer'

// Use built-in Helvetica font for reliable Turkish character rendering
// Helvetica has good Unicode support including Turkish characters
// This avoids external font loading issues that can cause DataView errors

// EnerjiOS Logo Component - Simplified for React-PDF compatibility
const EnerjiOSLogo: React.FC<{ width?: number; height?: number }> = ({ width = 120, height = 40 }) => (
  <Svg viewBox="0 0 300 100" style={{ width, height }}>
    {/* Background circle with gradient effect using solid colors */}
    <Circle cx="45" cy="50" r="35" fill="#FF6B35" opacity={0.9}/>
    <Circle cx="45" cy="50" r="30" fill="#F7931E" opacity={0.7}/>
    <Circle cx="45" cy="50" r="25" fill="#FFD23F" opacity={0.5}/>
    
    {/* Energy rays/lines radiating from center */}
    <Line x1="45" y1="20" x2="45" y2="30" stroke="white" strokeWidth="2"/>
    <Line x1="65" y1="30" x2="60" y2="35" stroke="white" strokeWidth="2"/>
    <Line x1="70" y1="50" x2="60" y2="50" stroke="white" strokeWidth="2"/>
    <Line x1="65" y1="70" x2="60" y2="65" stroke="white" strokeWidth="2"/>
    <Line x1="45" y1="80" x2="45" y2="70" stroke="white" strokeWidth="2"/>
    <Line x1="25" y1="70" x2="30" y2="65" stroke="white" strokeWidth="2"/>
    <Line x1="20" y1="50" x2="30" y2="50" stroke="white" strokeWidth="2"/>
    <Line x1="25" y1="30" x2="30" y2="35" stroke="white" strokeWidth="2"/>
    
    {/* Central power symbol */}
    <Circle cx="45" cy="50" r="8" fill="none" stroke="white" strokeWidth="2"/>
    <Line x1="45" y1="44" x2="45" y2="52" stroke="white" strokeWidth="2"/>
    
    {/* Tech accent elements */}
    <Rect x="250" y="25" width="3" height="8" fill="#3498DB" opacity={0.6}/>
    <Rect x="255" y="30" width="3" height="6" fill="#3498DB" opacity={0.6}/>
    <Rect x="260" y="28" width="3" height="10" fill="#3498DB" opacity={0.6}/>
    <Rect x="265" y="32" width="3" height="4" fill="#3498DB" opacity={0.6}/>
    
    <Rect x="250" y="65" width="3" height="6" fill="#3498DB" opacity={0.6}/>
    <Rect x="255" y="62" width="3" height="10" fill="#3498DB" opacity={0.6}/>
    <Rect x="260" y="67" width="3" height="8" fill="#3498DB" opacity={0.6}/>
    <Rect x="265" y="64" width="3" height="6" fill="#3498DB" opacity={0.6}/>
  </Svg>
)
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.logoSection}>
            ...
            <View style={styles.companyInfo}>
              ...
              <Text style={styles.companyTagline}>Güneş Enerjisi Yönetim Platformu</Text>
              <Text style={styles.companyContact}>
                8 Kasım Mah Tekcan Cad 52/A 39750 Lüleburgaz / Kırklareli • +90 541 593 26 55 • +90 288 415 20 05 • info@enerjios.com • www.enerjios.com
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <View style={styles.tableCellProduct}>
              <Text style={styles.productName}>Kurulum ve İşçilik</Text>
          ...
          {project.estimatedCost && project.actualCost && (
            <View style={styles.totalRow}>
              ...
              <Text style={[styles.totalValue, { 
                ...
                {project.actualCost > project.estimatedCost ? ' (Fazla)' : ' (Tasarruf)'}
              </Text>
            </View>
          )}
        </View>
